...
static void usart_setup(void)
{
  ...
  gpio_mode_setup(SPI1_USART2_PORT, GPIO_MODE_AF, GPIO_PUPD_NONE, GPIO_USART_TX_PIN);
  gpio_set_af(SPI1_USART2_PORT, GPIO_USART_AF, GPIO_USART_TX_PIN);
  /* Config USART params. */
...
static void spi_setup(void)
{
  ...
  gpio_set_af(SPI1_USART2_PORT, SPI_AF,
              SPI_SCK_PIN | SPI_MISO_PIN | SPI_MOSI_PIN);  //
  gpio_set_output_options(SPI1_USART2_PORT, GPIO_OTYPE_PP, GPIO_OSPEED_50MHZ,
